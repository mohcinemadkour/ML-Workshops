...
def vis_network(nodes, edges, fil, physics=False):
    html = """
    <html>
    <head>
    <title>result</title>  
    ...
    <link src="https://cdnjs.cloudflare.com/ajax/libs/vis/4.21.0/vis.css" rel="stylesheet" type="text/css">
...
def draw(data,options, fil, physics=False, limit=100):
    ...
    return vis_network(nodes, edges, fil, physics=physics)